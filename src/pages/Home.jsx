...
const noisePattern =
  "data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)' opacity='0.03'/%3E%3C/svg%3E";
...
const Home = () => {
  ...
  const testimonials = [
    ...
    {
      quote:
        "Liquid gold. The texture is velvety, and the peppery finish indicates the incredibly high polyphenol content. Truly world-class.",
      author: "Marcus Vane",
    ...
    {
      quote:
        "The organic integrity and craftsmanship are evident in every drop. Our guests immediately note the difference in flavor profile.",
    ...
    <div className="overflow-hidden bg-surface-container-low">
        ...
        <div className="relative z-20 flex flex-col items-center justify-center w-full max-w-4xl px-container-padding mt-20 text-center mx-auto">
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {heroBackgrounds[bgIndex].subline} &bull; Experience the liquid
                gold of the Mediterranean, cold-pressed with ancestral devotion.
              </motion.p>
            </AnimatePresence>
      ...
      <section className="pt-16 pb-12 px-container-padding bg-surface-container-low relative">
        ...
        >
          ...
          <div className="absolute top-12 left-[15%] right-[15%] h-6 hidden md:block z-0 pointer-events-none">
            <svg
              className="w-full h-full text-[#d4af37]/35"
              viewBox="0 0 800 20"
          ...
          <motion.div variants={fadeIn} className="group relative z-10">
            ...
            <p className="text-on-surface-variant leading-relaxed text-body-md font-light text-sm">
              Certified organic farming practices that respect the Tunisian soil
          ...
          <motion.div variants={fadeIn} className="group relative z-10">
            ...
            <p className="text-on-surface-variant leading-relaxed text-body-md font-light text-sm">
              Each olive is gently hand-picked at peak ripeness to ensure zero
              bruising and maximum flavor profile.
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeIn} className="group relative z-10">
            ...
            <p className="text-on-surface-variant leading-relaxed text-body-md font-light text-sm">
              Extracted without heat or chemicals, preserving the antioxidants
              and polyphenols for pure health.
            </p>
          </motion.div>
        </motion.div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-body-md text-on-surface-variant font-light leading-relaxed text-sm md:text-base">
              Witness the passion, precision, and natural beauty that defines
              every stage of our harvest in the olive fields of Tunisia.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-black/30 flex flex-col justify-between p-6 md:p-8">
              <div className="flex justify-between items-center w-full">
                <span className="font-logo text-white text-base md:text-lg tracking-widest drop-shadow-md">
                  OLIV'OR
                </span>
                <span className="text-white/80 text-xs font-semibold uppercase tracking-widest drop-shadow-md bg-black/20 px-3 py-1.5 rounded-full backdrop-blur-md border border-white/10">
                  Harvest Season
                </span>
              </div>
              ...
              <div className="flex justify-between items-end w-full mt-auto">
                <div className="text-left text-white max-w-xs md:max-w-md drop-shadow-md">
                  ...
                  <h4 className="text-lg md:text-2xl font-serif italic font-medium">
                    Tunisian Sun, Bottled
                  </h4>
                </div>
                  ...
                  <div className="relative text-left">
                    ...
                    <Link to={`/product/${productId}`}>
                      <div className="relative overflow-hidden rounded-2xl mb-4 aspect-[4/5] bg-surface-container-low border border-outline-variant/10">
                        ...
                        {product.badge && (
                          <div
                            className={`absolute top-3 left-3 font-mono text-[9px] font-bold tracking-widest uppercase px-3 py-1 rounded-full ${getBadgeStyle(product.badge)}`}
                          >
                            {product.badge}
                          </div>
                        )}
                    ...
                    >
                      <Heart
                        className={`h-4.5 w-4.5 ${isInWishlist ? "fill-primary text-primary" : "text-outline hover:text-primary"}`}
                      />
                    </button>
                  ...
                  <div>
                    <div className="flex justify-between items-center pt-4 border-t border-outline-variant/10">
                      <div className="flex flex-col text-left">
                        <span className="text-[9px] text-outline font-bold uppercase tracking-widest font-mono">
                          Price
                        </span>
                        <span
        ...
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant leading-relaxed font-light text-sm md:text-base">
              ...
              groves of the Tunisian Sahel. Our methods haven't changed much
              since the days of Carthage — we still listen to the trees, we
              still harvest under the Mediterranean sun, and we still honor the
              liquid gold that has sustained our culture for millennia.
            </p>
            ...
            <div className="pt-6">
              <Link
                to="/heritage"
                className="inline-flex items-center gap-2 text-primary font-mono text-[10px] uppercase tracking-widest group font-bold"
              >
      ...
      <section className="py-28 bg-surface-container relative">
        ...
        <div className="max-w-[1440px] mx-auto px-container-padding grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-gutter h-auto md:h-[800px] relative z-10">
          ...
          {(() => {
            const p1 =
              products.find((p) => p.title === "Reserve Collection") ||
              products[0];
                ...
                {p1 && (
                  <>
                    ...
                    <div className="relative z-10 text-white text-left">
                      ...
                      <Link
                        to={`/product/${p1Id}`}
                        className="inline-block bg-white text-primary px-8 py-3 rounded-full font-mono text-[10px] uppercase tracking-widest hover:bg-secondary-container hover:text-on-secondary-container transition-colors text-center font-bold"
                      >
                        Shop {p1.title}
                      </Link>
                    </div>
          ...
          {(() => {
            const p2 =
              products.find((p) => p.title === "Chemlali Gold") || products[1];
                ...
                {p2 && (
                  <>
                    <div className="z-10 w-1/2 text-left">
                      ...
                      <span
                        className="font-serif text-primary text-xl md:text-2xl block mb-2 font-bold"
                        style={{ fontFamily: "'Fraunces', serif" }}
                      >
                        ${p2.price.toFixed(2)}
                      </span>
                      <Link
                        to={`/product/${p2Id}`}
                        className="inline-block bg-primary text-white px-6 py-2.5 rounded-full font-mono text-[10px] uppercase tracking-widest hover:bg-primary-container transition-colors text-center font-bold mt-2"
                      >
                        Buy Now
                      </Link>
                    </div>
          ...
          >
            ...
            <div className="relative z-10 text-white text-center space-y-2">
              <h4
                className="font-serif text-white text-xl md:text-2xl font-bold"
                style={{ fontFamily: "'Fraunces', serif" }}
              >
                Servingware
              </h4>
      ...
      <section className="py-36 px-container-padding bg-background border-t border-outline-variant/10 relative overflow-hidden">
        ...
        <div className="max-w-[1000px] mx-auto text-center relative min-h-[360px] flex items-center justify-center">
          ...
          <span className="absolute -top-12 left-1/2 transform -translate-x-1/2 text-[15rem] font-serif text-[#d4af37]/8 select-none pointer-events-none leading-none z-0">
            “
          </span>
              ...
              <div
                ...
                className={`transition-opacity duration-1000 ease-in-out absolute inset-0 flex flex-col justify-center items-center ${
                  testiIndex === idx
                    ...
                    : "opacity-0 absolute pointer-events-none z-0"
                }`}
              >
                <blockquote
